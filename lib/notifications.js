...
export const sendEmailVerificationEmail = async ({
 ...
 try {
  ...
  const mailOptions = {
   from: process.env.EMAIL_FROM || process.env.EMAIL_USER || "noreply@profilo.com",
   to: userEmail,
   subject: `✅ PROFILO - Email Doğrulama Kodu`,
   html: `
    <!DOCTYPE html>
    <html>
      <head>
                ...
                <tr>
                  <td style="background:#fff;padding:22px 24px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                    ...
                    <div style="margin-top:8px;font-size:13px;color:#374151;line-height:1.6;">
                      PROFILO'ya hoş geldiniz! Hesabınızı aktifleştirmek için aşağıdaki doğrulama kodunu kullanabilir veya doğrudan linke tıklayabilirsiniz.
                    </div>
          ...
          <tr>
            <td align="center" class="container" style="padding:24px;">
              <table role="presentation" style="width:100%;max-width:640px;border-collapse:collapse;">
                ...
                <!-- Body -->
                <tr>
                  <td class="card" style="background:#fff;padding:28px 24px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                    <table role="presentation" style="width:100%;border-collapse:collapse;">
                      <tr>
                        <td style="padding:0 0 16px 0;">
                          <div style="font-size:11px;color:#6b7280;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;">SİPARİŞ ÖZETİ</div>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:0;">
                          <table role="presentation" style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;border-radius:12px;border:1px solid #e5e7eb;background:#fafafa;">
                            <tr>
                              <td style="padding:16px 18px;background:#ffffff;border-bottom:1px solid #e5e7eb;">
                                <div style="display:flex;justify-content:space-between;gap:12px;align-items:center;">
                                  <div style="color:#6b7280;font-size:13px;font-weight:600;">Ödeme</div>
                                  <div style="color:#111827;font-size:14px;font-weight:700;">${paymentMethod || '-'}</div>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td style="padding:16px 18px;background:#ffffff;">
                                <div style="display:flex;justify-content:space-between;gap:12px;align-items:center;">
                                  <div style="color:#6b7280;font-size:13px;font-weight:600;">Tutar</div>
                                  <div style="color:#4f46e5;font-size:20px;font-weight:900;letter-spacing:-0.5px;">${Number(total || 0).toFixed(2)} ₺</div>
                                </div>
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        <td style="padding:24px 0 16px 0;">
                          <div style="font-size:11px;color:#6b7280;font-weight:700;text-transform:uppercase;letter-spacing:.08em;">MÜŞTERİ BİLGİLERİ</div>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:0;">
                          <table role="presentation" style="width:100%;border-collapse:separate;border-spacing:0;border-radius:12px;border:1px solid #e5e7eb;background:#ffffff;overflow:hidden;">
                            <tr>
                              <td style="padding:16px 18px;border-bottom:1px solid #f3f4f6;">
                                <div style="font-size:11px;color:#9ca3af;font-weight:600;text-transform:uppercase;letter-spacing:.05em;margin-bottom:6px;">Müşteri</div>
                                <div style="font-size:15px;color:#111827;font-weight:700;margin-top:4px;line-height:1.4;">${userName || '-'}</div>
                              </td>
                            </tr>
                            <tr>
                              <td style="padding:16px 18px;border-bottom:1px solid #f3f4f6;">
                                <div style="font-size:11px;color:#9ca3af;font-weight:600;text-transform:uppercase;letter-spacing:.05em;margin-bottom:6px;">E-posta</div>
                                <div class="email-text" style="font-size:15px;color:#111827;font-weight:600;margin-top:4px;line-height:1.4;word-break:break-all;text-decoration:none !important;">
                                  ${userEmail || '-'}
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td style="padding:16px 18px;">
                                <div style="font-size:11px;color:#9ca3af;font-weight:600;text-transform:uppercase;letter-spacing:.05em;margin-bottom:6px;">Telefon</div>
                                <div style="font-size:15px;color:#111827;font-weight:600;margin-top:4px;line-height:1.4;">${userPhone || '-'}</div>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td style="padding:24px 0 16px 0;">
                          <div style="font-size:11px;color:#6b7280;font-weight:700;text-transform:uppercase;letter-spacing:.08em;">ADRES</div>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:0;">
                          <div style="background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;padding:18px 20px;color:#374151;font-size:14px;line-height:1.7;font-weight:500;">
                            ${addressSummary || '-'}
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td style="padding:28px 0 0 0;">
                          <a class="cta"
                             ...
                             style="background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 100%);color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;padding:16px 24px;border-radius:10px;display:inline-block;box-shadow:0 4px 6px -1px rgba(79,70,229,0.3);transition:all 0.2s;">
                            Admin Paneline Git →
                          </a>
                        </td>
                      </tr>
                ...
                <!-- Footer -->
                <tr>
                  <td style="background:#f9fafb;border:1px solid #e5e7eb;border-top:none;padding:20px 24px;border-radius:0 0 18px 18px;">
                    <div style="color:#6b7280;font-size:12px;line-height:1.6;text-align:center;">
                      Bu e-posta otomatik oluşturuldu. Sipariş detaylarını admin panelinden görüntüleyebilirsiniz.
                    </div>
                    <div style="color:#9ca3af;font-size:11px;margin-top:12px;text-align:center;font-weight:500;">
                      © ${new Date().getFullYear()} PROFILO. Tüm hakları saklıdır.
                    </div>
                  </td>
                </tr>
              </table>
